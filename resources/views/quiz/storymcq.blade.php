...
.option input:checked + .option-box {
    /* Background: A soft, readable mint green */
    background-color: #e7f3ff; /* Very light blue/green tint */
    
    /* Border: Stronger accent color */
    border-color: #1877f2; /* Facebook Blue or use #198754 for Green */
    
    /* Text: High contrast dark color */
    color: #025c1a; 
    
    /* Extra: Subtle glow to make it pop */
