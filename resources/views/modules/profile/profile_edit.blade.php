    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="name" class="form-control" type="text" value="{{ $editData->first_name }}"  id="example-text-input">
                </div>
            </div>
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="email" class="form-control" type="text" value="{{ $editData->user_email }}"  id="example-text-input">
                </div>
            </div>
            <!-- end row -->
